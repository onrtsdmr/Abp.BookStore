...
namespace Elementym.BookStore.Permissions
{
    public class BookStorePermissionDefinitionProvider : PermissionDefinitionProvider
    {
        public override void Define(IPermissionDefinitionContext context)
        {
            ...
            booksPermission.AddChild(BookStorePermissions.Books.Root, L("Permission:Books.Root"));
            ...
            authorsPermission.AddChild(BookStorePermissions.Authors.Root, L("Permission:Authors.Root"));
        }
